...
public class BackendServiceResourceNames : ResourceNames
{
    ...
    public string BackendContainerImageVersion => System.Environment.GetEnvironmentVariable("BACKEND_SERVICE_IMAGE_TAG") ?? "37663a75b00a2ecf71fba97c5e5fcc80fb9fd817";
